...
define([
    ...
    return Backbone.View.extend({
        ...
        initialize: function() {
            ...
            $('title').text(this.model.get('name') + ' |> TrackDragon');
        ...
        scrollHandler: function() {
            ...
            Dragon.Views.Tracks.trigger('Dragon:scroll');  
            Dragon.Views.Timeline.trigger('Dragon:scroll');
        },
        ...
        zoomHandler: function(e) {
            ...
            if (e.altKey) {
                ...
                var originalOffset = Dragon.Display.px2sec(e.originalEvent.offsetX);
                (e.originalEvent.wheelDelta < 0) ? Dragon.Display.zoomOut() : Dragon.Display.zoomIn();
                var newOffset = Dragon.Display.sec2px(originalOffset),
        ...
        unsetActiveTrack: function() {
            Dragon.Views.Tracks.clearDisplays();
        ...
        setClipboard: function() {
            ...
            if (!isNaN(this.selectionFrom) && this.selectionFrom !== this.selectionTo) {
                ...
                $tracks.slice(index1, ++index2).each(function() {
                    cid = $(this).data('cid');
                    clipboard.tracks[cid] = Dragon.Collections.Tracks.getSnapshot(that.selectionFrom, that.selectionTo, cid);
                });
        ...
        pasteClipboard: function() {
            ...
            for (var cid in clipboard.tracks) {
                Dragon.Collections.Tracks.pasteSelection(cid, cursor, clipboard.tracks[cid]);
            }            
        },
        ...
        deleteSelection: function() {
            ...
            if (!isNaN(this.selectionFrom) && this.selectionFrom !== this.selectionTo) {
                ...
                $tracks.slice(index1, ++index2).each(function() {
                    cid = $(this).data('cid');
                    Dragon.Collections.Tracks.deleteSelection(that.selectionFrom, that.selectionTo, cid);
                });
            }
        },
        ...
        splitClip: function() {
            ...
            Dragon.Collections.Tracks.getByCid(cid).deleteSelection(cursor, cursor);
        }
    });
});