...
define([
    ...
    'Dragon/Views.TrackDisplay',
    'Dragon/Views.TrackControls',
    'Dragon/Views.Clips'
    ...
    return Backbone.View.extend({
        ...
        initialize: function () {
            ...
            this.model.bind('Dragon:zoomChange', this.zoomChange);
            this.model.bind('Dragon:clearDisplay', this.clearDisplay);
        },

        render: function() {
            var offsetLeft = Dragon.Views.Editor.scrollLeftOffset(),  
                width = Dragon.Display.sec2px(this.model.get('length')),
