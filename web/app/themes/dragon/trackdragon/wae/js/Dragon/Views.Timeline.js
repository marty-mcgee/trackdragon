...
define([
    ...
    return Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.bind('Dragon:scroll', this.drawScale);
            this.bind('Dragon:zoomChange', this.drawScale);
        ...
        drawScale: function() {
            var $el = $(this.el),
                ...
                intervals = Dragon.Display.getIntervals(minFrame),      // interval (sec) + division interval
                interval = Dragon.Display.sec2px(intervals.interval),   // main time labels interval (px)
                sub = interval / intervals.subdivision,                 // sub ticks interval (px)
                offsetLeft = Dragon.Views.Editor.scrollLeftOffset(),    // left scroll offset (px)
                timeLeft = Dragon.Display.px2sec(offsetLeft),
            ...
            timeLeft += Dragon.Display.px2sec(i);
